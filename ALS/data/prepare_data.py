...
user,item,rating = np.loadtxt('dataset.txt', delimiter='\t', dtype=np.int32, unpack=True)
print user
print item
print rating
print np.max(user)
...
user_item_train, user_item_test, rating_train, rating_test = train_test_split(user_item.T, rating, test_size=1000, random_state=42)
nnz_train = 100000 - 1000
nnz_test = 1000
